...
if __name__ == "__main__":
    ...
    plt.text(3.3,90,'Vincenty: 4 CPU',rotation=90,fontsize=16,color='k',backgroundcolor='w')
    plt.text(4.3,90,'Circle: 4 CPU',rotation=90,fontsize=16,color='k',backgroundcolor='w')
    plt.xticks([],[])
